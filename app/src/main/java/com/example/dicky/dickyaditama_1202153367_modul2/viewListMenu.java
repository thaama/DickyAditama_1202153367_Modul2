...
public class viewListMenu extends RecyclerView.Adapter<viewListMenu.ViewHolder> {
    ...
    public viewListMenu(ArrayList<String> inputData, ArrayList<String> dataHarga, ArrayList<Integer> gambar) {
        menuData = inputData;
        menuHarga = dataHarga;
        menuGambar = gambar;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // membuat view baru
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_view_list_menu, parent, false);
